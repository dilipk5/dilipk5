...
[![Typing SVG](https://readme-typing-svg.demolab.com/?lines=Red+Team+🔍;Security+Researcher+🛡️;Penetration+Tester+⚔️;Building+Detections+By+Day;Breaking+Things+By+Night&font=Fira%20Code&center=true&width=500&height=50&duration=4000&pause=1000&color=F75C7E)](https://git.io/typing-svg)
...
### 🎯 What I Do
- ⚔️ **Offensive Security**: Pentest tooling (Burp Suite, Metasploit, Bloodhound), vulnerability research
- ☁️ **Cloud Security**: AWS security monitoring (CloudTrail, IAM), infrastructure as code
- 🔍 **Detection Engineering**: Crafting Sigma/Yara rules and hunting threats using MITRE ATT&CK TTPs
- 🛡️ **SIEM & SOC**: Splunk correlation searches, log analysis, and incident investigation
- 🧠 **Security Research**: DNS exfiltration, detection gaps, OSINT, threat intelligence
...
[![Skills](https://skillicons.dev/icons?i=python,bash,c,cpp,aws,docker,git,linux,vim,vscode&theme=dark)](https://skillicons.dev)

**Detection & Blue Team:** Splunk · Sigma · Yara · MITRE ATT&CK · Zeek · Wireshark  
**Offensive Tools:** Burp Suite · Metasploit · Bloodhound · Mimikatz · SQLMap · Hydra  
**Cloud & DevOps:** AWS · Docker · CloudTrail · IAM · EC2 · S3  
...
💡 *Building detections by day, breaking things by night. Always learning, always securing.*
